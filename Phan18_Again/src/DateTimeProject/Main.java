...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(May5.withDayOfYear(288));
        System.out.println(May5);
        System.out.println(May5.with(ChronoField.DAY_OF_YEAR, 189));
        ...
        System.out.println(sevenThirtyPM.plus(7, ChronoUnit.HOURS));
        ...
        LocalDateTime May5Noon = LocalDateTime.of(2025, 10, 15,
                12, 0, 15);
